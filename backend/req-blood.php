...
<table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
  ...
  <tr>
    ...
    <td>        
        <a data-tooltip title="Delete" href="edit_delete_modal2.php?id=<?php echo $prop['id']; ?>" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i></a> 
    </td>
