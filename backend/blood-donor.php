...
<table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
  ...
  <?php
  $sn=1;
  $psql = mysqli_query($dbcon,"SELECT * FROM becomeadonor ORDER BY id DESC");
  while($prop = mysqli_fetch_array($psql)){ ?>
  <tr>

    <td><?php echo $sn++; ?></td>
    <td><?php echo $prop['firstname']; ?></td>
    <td><?php echo $prop['lastname']; ?></td>
    <td><?php echo $prop['email']; ?></td>
    <td><?php echo $prop['phone']; ?></td>
    <td><?php echo $prop['bgroup']; ?></td>
    <td><?php echo $prop['dob']; ?></td>
    <td><?php echo $prop['address']; ?></td>
    <td><?php echo $prop['lga']; ?></td>
    <td><?php echo $prop['state']; ?></td>
    <td><?php echo $prop['zip']; ?></td>
    <td><?php echo $prop['hivtest']; ?></td>
    <td>        
        <a data-tooltip title="Delete" href="edit_delete_modal.php?id=<?php echo $prop['id']; ?>" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i></a> 
    </td>
